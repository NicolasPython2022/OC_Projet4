'''Le fichier main.py comporte la logique de mon programme.'''
...
2 - Appel de la method qui recupere les infos d'un joueur :
    controller.view.get_player_data()
'''
    ...
    while True:
        ...
        if display_menu == '1':
            ...
            if os.path.exists(controller.data_path):
                ...
                print(
                    '''
                    Pas de fichier de tournoi enregistré,
            ...
            if os.path.exists(controller.data_path):
                ...
                while choised_tournement not in data_tournement.keys()\
                        and choised_tournement != None:
                    print("La valeur entrée n'est pas valide")
                    choised_tournement =\
                        controller.view.get_tournement_to_play(data_tournement)
            ...
            if os.path.exists(controller.data_path):
                ...
                while choised_tournement not in data_tournement.keys()\
                    ...
                    print("La valeur entrée n'est pas valide")
                    choised_tournement =\
                        controller.view.get_tournement_to_replay(
                            data_tournement)
